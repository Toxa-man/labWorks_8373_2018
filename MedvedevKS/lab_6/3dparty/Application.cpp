...
void bonusLvl(float k, unsigned int move, unsigned int deerX, unsigned int deerAnimationSize, unsigned int deerTextureW, bool& gameOver, bool& gamehappening, bool& mainMenu, const Uint8 *keyboardState, animated_obj deer, unsigned int& score, SDL_Renderer* ren, SDL_DisplayMode displayMode, obj *ground, text scoreText)
{
    ...
    tube1.rect.x = displayMode.w;
    tube1.rect.y = -rand() % groundH * 3;// / 0.75;
    tube1.rect.w = tubeW;
    tube1.rect.h = tubeH;

    obj tube2;
    tube2.texture = IMG_LoadTexture(ren, "textures/newBonusPipe.png");
    tube2.rect.x = displayMode.w;
    tube2.rect.y = -rand() % groundH * 3;// / 0.75;
    tube2.rect.w = tubeW;
    tube2.rect.h = tubeH;
    ...
    while(bonus)
    {
        ...
        if (deer.dstrect.y >= displayMode.h - deer.dstrect.h - groundH)// - deerAnimationSize)
        {
            deer.dstrect.y = displayMode.h - deer.dstrect.h - groundH;// - deerAnimationSize;
            move = 0;
        }
...
/*
    ...
    tree.dstrect.x = displayMode.w / 4;
    tree.dstrect.y = displayMode.h / 2.4;
    ...
    deer.dstrect.y = displayMode.h - deerH - groundH;
...
menuExitCode startMenu(float k, const Uint8 *keyboardState, bool& mainMenu, SDL_Renderer *ren, const SDL_DisplayMode displayMode, Mix_Music *avaria, Mix_Music *blestyashie, Mix_Music *digi, Mix_Music *elka, Mix_Music *verka)
{
    ...
    blue[WTTCDG].rect.w = displayMode.w * 4 / 5;
    blue[WTTCDG].rect.h = frameH * 2 / 3;
    blue[WTTCDG].rect.x = (displayMode.w - blue[WTTCDG].rect.w)/2;
